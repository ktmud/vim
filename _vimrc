...
" Last Change: 2010-07-23 21:18:24
"
...
au VimLeave * mksession! $VIMFILES/basicSession.vim
au VimLeave * wviminfo! $VIMFILES/basicSession.viminfo
...
function! CurDir()
    let curdir = substitute(getcwd(), 'C:\Documents and Settings\quichi', "~/", "g")
    return curdir
endfunction
...
let Tlist_Ctags_Cmd = 'd:\dev\ctags58\ctags.exe' "location of ctags
